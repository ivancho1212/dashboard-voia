...
export default styled(Badge)(({ theme, ownerState }) => {
  ...
  const allowedColors = ["primary", "secondary", "info", "success", "warning", "error", "light", "dark"];
  ...
  return {
    "& .MuiBadge-badge": {
      ...
      ...(variant === "gradient" && gradientStyles(safeColor)),
      ...(variant === "contained" && containedStyles(safeColor)),

...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    const js = document.createElement('script'); js.id = 'voia-widget-js'; js.async = true; js.src = 'http://localhost:3000/widget.js'; js.setAttribute('data-user-id', '3'); js.setAttribute('data-bot-id', '24'); js.setAttribute('data-bot', '24'); js.setAttribute('data-api-base', 'http://localhost:3000'); js.setAttribute('data-theme', 'auto'); js.setAttribute('data-position', 'bottom-right'); js.setAttribute('data-language', 'es'); js.setAttribute('data-allowed-domain', 'http://localhost:3000/'); document.body.appendChild(js);
  }, []);
